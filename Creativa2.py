...
fout = open("productpage2.html", 'w') # out file
for line in fin:
    if "      <a class=\"navbar-brand\" href=\"#\">BookInfo Sample</a>" in line:
        fout.write("      <a class=\"navbar-brand\" href=\"#\"> Equipo: "+str(os.environ.get('GROUP_NUMBER'))+"</a>")
    else :
        fout.write(line)
fin.close()
fout.close()
...
webbrowser.open('http://192.168.122.1:9080/productpage')
